...
namespace Frotz.Screen {
    public class LineInfo {
        ...
        public String CurrentString { get { return PortableFrotz.PortableMethods.StringFromArray(_text, 0, LastCharSet + 1); } }
        ...
        public String GetString() {
            return PortableFrotz.PortableMethods.StringFromArray(_text, 0, width);
        }

        public String GetString(int start, int length) {
            return PortableFrotz.PortableMethods.StringFromArray(_text, start, length);
        }
