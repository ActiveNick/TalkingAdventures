...
namespace Frotz.Generic {
    ...
    {
        // TODO Remove this
        public static System.Collections.Generic.Dictionary<int, string> opcodesUsed = new System.Collections.Generic.Dictionary<int, string>();
        ...
        public static zbyte h_version = 0;
        ...
        public static int MainFunc(string _filename) {
            if (os_.process_arguments(_filename)) {
                ...
                // I think it should work to restore the game state here and then it would fall into the interpret 
                // loop with the proper information

#if WINDOWS_PHONE
                SaveMachineState.attemptRestore();
#endif

                Process.interpret();

#if WINDOWS_PHONE
                SaveMachineState.ClearState(); // TODO Make a function here that can be moved into the phone specific screen (os_.game_ended, which can hand it off)
#endif
