...
namespace Frotz.Generic
{
    internal static class Files
    {
        ...
        static System.IO.Stream pfp = null;
        ...
        internal static void script_open()
        {
            ...
            {
                if (os_.read_file_name(out stream, General.DEFAULT_SCRIPT_NAME, FileTypes.FILE_SCRIPT) != true)
                    goto done;

                // script_name = new_name;
            }

            if ((sfp = new System.IO.StreamWriter(stream)) != null)
            {
        ...
        internal static void record_open()
        {
            ...
            if (os_.read_file_name(out stream, command_name, FileTypes.FILE_RECORD) == true)
            {
                // command_name = new_name;

                if ((rfp = new System.IO.StreamWriter(stream)) != null)
                {
        ...
        internal static void replay_open()
        {
            ...
            if (os_.read_file_name(out stream, command_name, FileTypes.FILE_PLAYBACK))
            {
                // command_name = new_name;

                // if ( (pfp = new System.IO.FileStream(stream, System.IO.FileMode.Open)) != null) {
                pfp = stream;
