...
namespace Frotz.Generic
{
    ...
    internal static class FastMem
    {
        ...
        internal static System.IO.MemoryStream story_fp = null;

        internal static bool first_restart = true;
        internal static long init_fp_pos = 0;
        ...
        internal static byte PEEK_CODE_BYTE()
        {
            return ZMData[pcp];
        }
        ...
        {
            if (story_fp != null) story_fp.Dispose();
        ...
        internal static void z_restore()
        {
            ...
            else
            {
                ...
                if (!os_.read_file_name(out stream, save_name, FileTypes.FILE_RESTORE))
                    goto finished;
                ...
                {
                    byte[] buffer = new byte[gfp.Length];
                    gfp.Read(buffer, 0, buffer.Length);


                    var ms = new System.IO.MemoryStream(buffer);
                    success = Quetzal.restore_quetzal(ms, story_fp);
        ...
        internal static void z_save()
        {
            ...
            {
                System.IO.Stream stream = null;
                if (!os_.read_file_name(out stream, save_name, FileTypes.FILE_SAVE))
                    goto finished;
                ...
                if (main.option_save_quetzal == true)
                {
                    ...
                    success = Quetzal.save_quetzal(ms, story_fp);
