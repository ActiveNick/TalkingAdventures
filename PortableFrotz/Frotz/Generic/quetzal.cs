...
namespace Frotz.Generic {
    internal static class Quetzal {
        ...
        private static bool write_run(System.IO.Stream fp, byte run)
        {
            write_byte(fp, 0);
            write_byte(fp, run);
            return true;
        ...
        private static bool write_byte(System.IO.Stream fp, int b)
        {
            fp.WriteByte((byte)b);
            return true;
        }

        private static bool write_bytx(System.IO.Stream fp, int b)
        {
        ...
        private static bool write_word(System.IO.Stream fp, int w)
        {
            write_bytx(fp, (w) >> 8);
            write_bytx(fp, (w));
            return true;
        ...
        private static bool write_bytx(System.IO.Stream fp, long b)
        {
            write_byte(fp, (byte)((b) & 0xFF));
            return true;
        }

        private static bool write_long(System.IO.Stream fp, long l)
        {
            write_bytx(fp, (l) >> 24);
            write_bytx(fp, (l) >> 16);
            write_bytx(fp, (l) >> 8);
        ...
        internal static bool write_chnk(System.IO.Stream fs, long id, long len) {
            write_long(fs, id);
            write_long(fs, len);
        ...
        static bool read_word(System.IO.Stream fs, out zword result) {
            int a, b;
        ...
        static bool read_long(System.IO.Stream fs, out zlong result) {
        ...
        internal static zword restore_quetzal(System.IO.Stream svf, MemoryStream stf) {
        ...
        internal static zword save_quetzal(System.IO.Stream svf, MemoryStream stf) {
