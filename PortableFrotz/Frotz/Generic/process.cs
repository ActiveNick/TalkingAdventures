...
namespace Frotz.Generic
{
    ...
    internal static class Process
    {
        ...
        // TODO make these internal again
        ...
        private static void private_invoke(zinstruction instruction, string array, int index, int opcode)
        {
            ...
            if (!main.opcodesUsed.ContainsKey(opcode))
            {
                main.opcodesUsed.Add(opcode, instruction.Method.Name);
            }
        }
        ...
        internal static void interpret()
        {
            do
            {
                ...
                opcode = FastMem.PEEK_CODE_BYTE();
                if (opcode - 0xc0 == 36)
                {
                    os_.OnReadLineStarted();
                }
