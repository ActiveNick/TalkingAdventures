...
namespace Frotz.Generic
{
    ...
    internal static class Screen
    {
        ...
        public static bool input_redraw = false;
        public static bool more_prompts = true;
        public static bool discarding = false;
        public static bool cursor = true;

        public static int input_window = 0;


        public static ZWindow[] wp = new ZWindow[8];
        
        public static int _cwp;
        public static ZWindow cwp
        {
            //private set {
            //    _cwp = value; 
            //}
