...
namespace ZTools
{
    public static class InfoDump
    {
        ...
        public static System.Collections.Generic.List<ZToolInfo> main(ref byte[] storyFile, String[] args) 
        {
            int i;
            // int c, f, errflg = 0;
            int columns;
            ...
            /* Process any story files on the command line */
                ...
                return process_story(ref storyFile, options, columns, symbolic);
        ...
        static System.Collections.Generic.List<ZToolInfo> process_story(ref byte[] storyFile, int[] options, int columns, int symbolic)
        {
            if (storyFile == null)
            {
                storyFile = Frotz.Generic.FastMem.ZMData;
            }
            ...
            show_map();
            _areas.Add(new ZToolInfo("File Map", txio.getTextFromStringBuilder()));
